...
public class Player extends MovingEntity {
    ...
    public Player(Controller controller, Motion motion, Position position, SpriteLibrary spriteLibrary, List<GameObject> mapObjects, List<GameObject> gameObjects) {
